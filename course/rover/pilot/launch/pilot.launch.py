...
watchdog) lives on the RP2040 coprocessor (`course/rover/mcu/`). The
mission-specific spray servo stays on Pi GPIO. The Pi runs five ROS 2
nodes: gps, navigator, mcu_bridge, spray, bridge (course server).
