// Display order only. Authorization uses explicit requirements from
// access-control.js; these values never imply inherited access.
export const ROLE_SORT_ORDER = { student: 1, official: 2, admin: 3 };
